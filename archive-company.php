		...
		<div class="large-12 columns">
			...
			<section class="archive-body">
				...
				<div class="items row1">
					...
					<?php
						$args = array('post_type' => 'company', 'post_per_page' => 2);
				...
				<div class="items row2">
					...
					<?php
						$args = array('post_type' => 'company', 'post_per_page' => 2, 'offset' => 2);
						$myPosts = get_posts($args);
						foreach($myPosts as $post): setup_postdata($post);
						$cat = get_the_category();
						$cat_info = $cat[0];
				...
				<div class="items row3">
					...
					<?php
						$args = array('post_type' => 'company', 'post_per_page' => 3, 'offset' => 4);
						$myPosts = get_posts($args);
						foreach($myPosts as $post): setup_postdata($post);
						$cat = get_the_category();
						$cat_info = $cat[0];
